 ...
 */
package com.ripped.pixeldungeon.items;

import java.util.HashMap;

import com.ripped.pixeldungeon.Dungeon;
import com.ripped.pixeldungeon.actors.hero.Hero;
import com.ripped.pixeldungeon.actors.mobs.npcs.Wandmaker.Rotberry;
import com.ripped.pixeldungeon.items.armor.*;
import com.ripped.pixeldungeon.items.bags.Bag;
import com.ripped.pixeldungeon.items.food.Food;
import com.ripped.pixeldungeon.items.food.MysteryMeat;
import com.ripped.pixeldungeon.items.food.Pasty;
import com.ripped.pixeldungeon.items.potions.*;
import com.ripped.pixeldungeon.items.rings.*;
import com.ripped.pixeldungeon.items.scrolls.*;
import com.ripped.pixeldungeon.items.wands.*;
import com.ripped.pixeldungeon.items.weapon.*;
import com.ripped.pixeldungeon.items.weapon.melee.*;
import com.ripped.pixeldungeon.items.weapon.missiles.*;
import com.ripped.pixeldungeon.plants.*;
...
public class Generator {
	...
	static {
		...
		Category.SEED.classes = new Class<?>[]{ 
			...
			Rotberry.Seed.class,
			Inert.Seed.class,
			SilverLeaf.Seed.class};
		Category.SEED.probs = new float[]{ 1, 1, 1, 1, 1, 1, 1, 0, 1, 1 };
	}
