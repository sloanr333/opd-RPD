...
import com.ripped.rippedpd.Chrome;
...
import com.ripped.rippedpd.ui.RedButton;
import com.ripped.rippedpd.ui.SimpleButton;
import com.ripped.rippedpd.ui.Window;
import com.ripped.rippedpd.utils.Utils;
import com.ripped.rippedpd.windows.WndList;
import com.ripped.rippedpd.windows.WndOptions;
import com.ripped.rippedpd.windows.WndTitledMessage;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		GemButton btns[] = {
			...
			new GemButton( HeroClass.PRIEST )};
		...
		btnMastery = new SimpleButton( Icons.MASTERY.get() ) {
			...
			protected void onClick() {
				...
				case HUNTRESS:
					...
					break;
				case PRIEST:
					text = HeroSubClass.DRUID.desc() + "\n\n" + HeroSubClass.ALCHEMIST.desc();
				}
	...
	private void updateClass( HeroClass cl ) {
		...
		if (cl != HeroClass.HUNTRESS || huntressUnlocked) {
			...
			case HUNTRESS:
				...
				break;
			case PRIEST:
				badgeToCheck= Badges.Badge.MASTERY_PRIEST;
				break;
			}
			btnMastery.active = 
			btnMastery.visible = 
