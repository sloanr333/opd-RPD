...
import com.ripped.rippedpd.actors.mobs.Senior;
import com.ripped.rippedpd.actors.mobs.Shielded;
import com.ripped.rippedpd.items.Item;
import com.ripped.rippedpd.items.bags.ScrollHolder;
import com.ripped.rippedpd.items.bags.SeedPouch;
import com.ripped.rippedpd.items.bags.WandHolster;
import com.ripped.rippedpd.items.potions.Potion;
import com.ripped.rippedpd.items.rings.Ring;
import com.ripped.rippedpd.items.rings.RingOfHaggler;
...
public class Badges {
	...
	public static enum Badge {
		...
		GAMES_PLAYED_5("3000 games played", 64,true),
	...
	public static void validateBossSlain() {
		...
		if (badge != null) {
			...
			if (badge == Badge.BOSS_SLAIN_1) {
				...
				case PRIEST:
					badge = Badge.BOSS_SLAIN_1_PRIEST;
					break;
				case HUNTRESS:
				...
				if (global.contains( Badge.BOSS_SLAIN_1_WARRIOR ) &&
					...
					global.contains(Badge.BOSS_SLAIN_1_PRIEST) &&
	...
	public static void validateGamesPlayed() {
		...
		if (Rankings.INSTANCE.totalNumber >= 3000) {
