...
public enum HeroSubClass {
	...
	DRUID("druid",
		"Druids are fast forces with a strong connection to nature. They sense seeds and dewdrops easier than " +
		"the other classes and has massive experience in melee combat."),
		
	ALCHEMIST("alchemist",
			"With their extensive knowledge of alchemy and science, alchemist's can identify ALL potions.");
