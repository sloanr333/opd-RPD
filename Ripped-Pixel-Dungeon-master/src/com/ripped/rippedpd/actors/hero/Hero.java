 ...
 */
package com.ripped.rippedpd.actors.hero;
...
import com.ripped.rippedpd.Bones;
import com.ripped.rippedpd.Dungeon;
import com.ripped.rippedpd.GamesInProgress;
import com.ripped.rippedpd.actors.Actor;
import com.ripped.rippedpd.actors.Char;
import com.ripped.rippedpd.actors.buffs.Barkskin;
...
import com.ripped.rippedpd.actors.buffs.Charm;
import com.ripped.rippedpd.actors.buffs.Combo;
import com.ripped.rippedpd.actors.buffs.Cripple;
import com.ripped.rippedpd.actors.buffs.Fury;
import com.ripped.rippedpd.actors.buffs.GasesImmunity;
import com.ripped.rippedpd.actors.buffs.Hunger;
import com.ripped.rippedpd.actors.buffs.Invisibility;
import com.ripped.rippedpd.actors.buffs.Light;
import com.ripped.rippedpd.actors.buffs.Ooze;
import com.ripped.rippedpd.actors.buffs.Paralysis;
import com.ripped.rippedpd.actors.buffs.Poison;
import com.ripped.rippedpd.actors.buffs.Regeneration;
import com.ripped.rippedpd.actors.buffs.Roots;
import com.ripped.rippedpd.actors.buffs.SnipersMark;
import com.ripped.rippedpd.actors.buffs.Weakness;
import com.ripped.rippedpd.actors.mobs.Mob;
import com.ripped.rippedpd.effects.CheckedCell;
import com.ripped.rippedpd.effects.Flare;
import com.ripped.rippedpd.effects.Speck;
import com.ripped.rippedpd.items.Amulet;
import com.ripped.rippedpd.items.Ankh;
import com.ripped.rippedpd.items.DewVial;
import com.ripped.rippedpd.items.Dewdrop;
import com.ripped.rippedpd.items.Heap;
import com.ripped.rippedpd.items.Item;
import com.ripped.rippedpd.items.KindOfWeapon;
import com.ripped.rippedpd.items.Heap.Type;
import com.ripped.rippedpd.items.armor.Armor;
import com.ripped.rippedpd.items.keys.GoldenKey;
import com.ripped.rippedpd.items.keys.IronKey;
import com.ripped.rippedpd.items.keys.Key;
import com.ripped.rippedpd.items.keys.SkeletonKey;
import com.ripped.rippedpd.items.potions.PotionOfExperience;
import com.ripped.rippedpd.items.potions.PotionOfFrost;
import com.ripped.rippedpd.items.potions.PotionOfHealing;
import com.ripped.rippedpd.items.potions.PotionOfInvisibility;
import com.ripped.rippedpd.items.potions.PotionOfLevitation;
import com.ripped.rippedpd.items.potions.PotionOfLiquidFlame;
import com.ripped.rippedpd.items.potions.PotionOfMight;
import com.ripped.rippedpd.items.potions.PotionOfMindVision;
import com.ripped.rippedpd.items.potions.PotionOfParalyticGas;
import com.ripped.rippedpd.items.potions.PotionOfPurity;
import com.ripped.rippedpd.items.potions.PotionOfStrength;
import com.ripped.rippedpd.items.potions.PotionOfToxicGas;
import com.ripped.rippedpd.items.rings.RingOfAccuracy;
import com.ripped.rippedpd.items.rings.RingOfDetection;
import com.ripped.rippedpd.items.rings.RingOfElements;
import com.ripped.rippedpd.items.rings.RingOfEvasion;
import com.ripped.rippedpd.items.rings.RingOfHaste;
import com.ripped.rippedpd.items.rings.RingOfShadows;
import com.ripped.rippedpd.items.rings.RingOfThorns;
import com.ripped.rippedpd.items.scrolls.ScrollOfMagicMapping;
import com.ripped.rippedpd.items.scrolls.ScrollOfRecharging;
import com.ripped.rippedpd.items.scrolls.ScrollOfUpgrade;
import com.ripped.rippedpd.items.wands.Wand;
import com.ripped.rippedpd.items.weapon.Weapon;
import com.ripped.rippedpd.items.weapon.melee.MeleeWeapon;
import com.ripped.rippedpd.levels.Level;
import com.ripped.rippedpd.levels.Terrain;
import com.ripped.rippedpd.levels.features.AlchemyPot;
import com.ripped.rippedpd.levels.features.Chasm;
import com.ripped.rippedpd.plants.Earthroot;
import com.ripped.rippedpd.scenes.GameScene;
import com.ripped.rippedpd.scenes.InterlevelScene;
import com.ripped.rippedpd.scenes.SurfaceScene;
import com.ripped.rippedpd.sprites.CharSprite;
import com.ripped.rippedpd.sprites.HeroSprite;
import com.ripped.rippedpd.ui.AttackIndicator;
import com.ripped.rippedpd.ui.BuffIndicator;
import com.ripped.rippedpd.ui.QuickSlot;
import com.ripped.rippedpd.utils.GLog;
import com.ripped.rippedpd.windows.WndMessage;
import com.ripped.rippedpd.windows.WndResurrect;
import com.ripped.rippedpd.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private void ready() {
		...
		if (subClass == HeroSubClass.ALCHEMIST) { 
			...
			new PotionOfLevitation().setKnown();
	...
	public void add( Buff buff ) {
		...
		if (sprite != null) {
			if (buff instanceof Burning) {
				...
				GLog.w( "Caustic ooze eats your flesh. It hurts.. Wash it away!" );
			} else if (buff instanceof Roots) {
				GLog.w( "You can't move your legs!" );
				...
				GLog.w( "You are charmed! <3" );
			}  else if (buff instanceof Cripple) {
				GLog.w( "You are crippled! ouch" );
	...
	public void die( Object cause  ) {
		...
		if (isAlive()) {
			new Flare( 8, 32 ).color( 0x2EFEF7, true ).show( sprite, 3f ) ;
			return;
		}
